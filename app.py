...
def make_predictions(df, selected_date):
    ...
    # Calculate MSE score
    mse_score = mean_squared_error(y_train, model.predict(X_train))

    return prediction, mse_score, end_time - start_time
...
def main():
    ...
    prediction, mse_score, execution_time = make_predictions(df, selected_date)
